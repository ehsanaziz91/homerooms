...
<html lang="en">
  <head>
    ...
    <meta http-equiv="REFRESH" content="5; url=http://localhost/homerooms/production/admin_discListPage.php"> <!--loading page in every 10 second-->

    <title>HMDS Disciplines List</title>
