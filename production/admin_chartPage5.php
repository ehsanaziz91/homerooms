              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                   <li><a href="admin_studListPage.php?userid=<?php echo $userid; ?>"><i class="fa fa-tasks"></i>Merit & Demerit</a></li>
                           ...
                           <li><a href="merit_schedule.php?userid=<?php echo $userid; ?>"><i class="fa fa-pencil-square-o"></i>Merit & Demerit Scheme</a></li>Scheme</a></li>
                </ul>
              </div>
              <div class="menu_section">
                <h3>Users</h3>
...
<!--              <div class="menu_section">
              ...
              <div class="menu_section">
                <h3>Report</h3>
                <ul class="nav side-menu">
                  <li><a href="admin_chartPage5.php?<?php echo $userid; ?>"><i class="fa fa-edit"></i>Record Analysis</a></li>
...
<!--                <li role="presentation" class="dropdown">
  ...
  series : [
      ...
      },
      {
          ...
          <div class="col-md-12 col-sm-6 col-xs-12" >
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                $merit1 = "SELECT * FROM record WHERE categoryID = 14 AND YEAR(date) = 2018  ";
                ...
                $merit2 = "SELECT * FROM record WHERE categoryID = 15 AND YEAR(date) = 2018 ";
                ...
                $merit3 = "SELECT * FROM record WHERE categoryID = 16 AND YEAR(date) = 2018 ";
                ...
                $merit4 = "SELECT * FROM record WHERE categoryID = 17 AND YEAR(date) = 2018 ";
              ...
              $merit17 = "SELECT * FROM record WHERE categoryID = 14 AND YEAR(date) = 2017  ";
              ...
              $merit27 = "SELECT * FROM record WHERE categoryID = 15 AND YEAR(date) = 2017 ";
              ...
              $merit37 = "SELECT * FROM record WHERE categoryID = 16 AND YEAR(date) = 2017 ";
              ...
              $merit47 = "SELECT * FROM record WHERE categoryID = 17 AND YEAR(date) = 2017 ";
         ...
         if (option && typeof option === "object") {
          ...
          <div class="col-md-12 col-sm-6 col-xs-12" >
            <div class="x_panel" >
              ...
              <div class="x_content">
                ...
                $demerit1 = "SELECT * FROM record WHERE categoryID = 1 AND YEAR(date) = 2018 ";
              ...
              $demerit2 = "SELECT * FROM record WHERE categoryID = 2 AND YEAR(date) = 2018 ";
            ...
            $demerit3 = "SELECT * FROM record WHERE categoryID = 3 AND YEAR(date) = 2018 ";
          ...
          $demerit4 = "SELECT * FROM record WHERE categoryID = 4 AND YEAR(date) = 2018 ";
        ...
        $demerit5 = "SELECT * FROM record WHERE categoryID = 5 AND YEAR(date) = 2018 ";
      ...
      $demerit6 = "SELECT * FROM record WHERE categoryID = 6 AND YEAR(date) = 2018 ";
    ...
    $demerit7 = "SELECT * FROM record WHERE categoryID = 7 AND YEAR(date) = 2018 ";
  ...
  $demerit8 = "SELECT * FROM record WHERE categoryID = 8 AND YEAR(date) = 2018 ";
...
$demerit9 = "SELECT * FROM record WHERE categoryID = 9 AND YEAR(date) = 2018 ";
...
$demerit10 = "SELECT * FROM record WHERE categoryID = 10  AND YEAR(date) = 2018";
...
$demerit11 = "SELECT * FROM record WHERE categoryID = 11 AND YEAR(date) = 2018 ";
...
$demerit12 = "SELECT * FROM record WHERE categoryID = 12  AND YEAR(date) = 2018";
...
$demerit13 = "SELECT * FROM record WHERE categoryID = 13 AND YEAR(date) = 2018 ";
...
$demerit17 = "SELECT * FROM record WHERE categoryID = 1 AND YEAR(date) = 2017 ";
...
$demerit27 = "SELECT * FROM record WHERE categoryID = 2 AND YEAR(date) = 2017 ";
...
$demerit37 = "SELECT * FROM record WHERE categoryID = 3 AND YEAR(date) = 2017 ";
...
$demerit47 = "SELECT * FROM record WHERE categoryID = 4 AND YEAR(date) = 2017 ";
...
$demerit57 = "SELECT * FROM record WHERE categoryID = 5 AND YEAR(date) = 2017 ";
...
$demerit67 = "SELECT * FROM record WHERE categoryID = 6 AND YEAR(date) = 2017 ";
...
$demerit77 = "SELECT * FROM record WHERE categoryID = 7 AND YEAR(date) = 2017 ";
...
$demerit87 = "SELECT * FROM record WHERE categoryID = 8 AND YEAR(date) = 2017 ";
...
$demerit97 = "SELECT * FROM record WHERE categoryID = 9 AND YEAR(date) = 2017 ";
...
$demerit107 = "SELECT * FROM record WHERE categoryID = 10  AND YEAR(date) = 2017";
...
$demerit117 = "SELECT * FROM record WHERE categoryID = 11 AND YEAR(date) = 2017 ";
...
$demerit127 = "SELECT * FROM record WHERE categoryID = 12  AND YEAR(date) = 2017";
...
$demerit137 = "SELECT * FROM record WHERE categoryID = 13 AND YEAR(date) = 2017 ";
