                  ...
                  <div class="x_content">
                    ...
                    <!--<form class="form-horizontal form-label-left input_mask" method="post">-->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input type="text" class="form-control" value="<?php echo $studname;?>" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Student Address</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Parent's Email</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
